...
library Mocks {
    ...
    function mock(function (IPool) external returns(bool) f, IPool param1) internal {
        vm.mockCall(f.address, abi.encodeWithSelector(f.selector, param1), abi.encode(0));
    }
    ...
    function mock(
        ...
        vm.mockCall(f.address, abi.encodeWithSelector(f.selector), abi.encode(returned1, returned2, returned3));
    }
    ...
    function mock(
        ...
        vm.mockCall(f.address, abi.encodeWithSelector(f.selector, param1, param2), abi.encode(returned1, returned2));
    }
    ...
    function mock(function (bytes12) external returns(int) f, bytes12 param1, int256 returned1) internal {
        vm.mockCall(f.address, abi.encodeWithSelector(f.selector, param1), abi.encode(returned1));
    }
    ...
    function mock(
        ...
        vm.mockCall(f.address, abi.encodeWithSelector(f.selector, param1, param2), abi.encode(returned1));
    }
    ...
    function mock(
        function (bytes12, uint128, uint128) external returns(DataTypes.Balances memory) f,
        bytes12 param1,
        uint128 param2,
        uint128 param3,
        DataTypes.Balances memory returned1
    ...
    function mock(
        function (address, bytes12, bytes6, bytes6) external returns(DataTypes.Vault memory) f,
        address p1,
        bytes12 p2,
        bytes6 p3,
        bytes6 p4,
        ...
        vm.mockCall(f.address, abi.encodeWithSelector(f.selector, p1, p2, p3, p4), abi.encode(r1));
    }
    ...
    function mock(
        ...
        vm.mockCall(f.address, abi.encodeWithSelector(f.selector, p1, p2), abi.encode(r1));
    }
    ...
    function verify(function (IPool) external returns(bool) f, IPool param1) internal {
        vm.expectCall(f.address, abi.encodeWithSelector(f.selector, param1));
    }
    ...
    function verify(
        ...
        vm.expectCall(f.address, abi.encodeWithSelector(f.selector, param1, param2));
    }
