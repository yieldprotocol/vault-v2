...
contract('Pool', async (accounts) => {
  ...
  it('should setup pool', async () => {
    ...
    const g2 = new BN('1000').mul(b).div(new BN('950')).add(new BN(1)) // Sell yDai to the pool
  })
  ...
  describe('with initial liquidity', () => {
    ...
    it('sells yDai', async () => {
      ...
      // daiOutForYDaiIn formula: https://www.desmos.com/calculator/7knilsjycu
    ...
    it('buys dai', async () => {
      ...
      // yDaiInForDaiOut formula: https://www.desmos.com/calculator/c1scsshbzh
    ...
    describe('with extra yDai reserves', () => {
      ...
      it('mints liquidity tokens', async () => {
        ...
        const expectedYDaiIn = new BN('517558731280000000')
      ...
      it('sells dai', async () => {
        ...
        // yDaiOutForDaiIn formula: https://www.desmos.com/calculator/8eczy19er3
      ...
      it('buys yDai', async () => {
        ...
        // daiInForYDaiOut formula: https://www.desmos.com/calculator/grjod0grzp
