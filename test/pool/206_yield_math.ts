...
function toBigNumber (x: any) {
  ...
  if (typeof x == 'number') return new BN (x);
     ...
     if (x.startsWith ('0x') || x.startsWith ('0X'))
       return new BN (x.substring (2), 16);
...
contract('YieldMath', async (accounts) =>  {
    ...
    it("Test `pow_2` function", async() => {
        ...
        for (var i = 0; i < xValues.length; i++) {
          ...
          assert (
            ...
            Math.abs (
              expected -
              Number (result [1])) <= Math.max (1.0000000000001, expected / 1000000000000.0));
        }
      });
        ...
        for (var i = 0; i < xValues.length; i++) {
          ...
          for (var j = 0; j < yzValues.length; j++) {
            ...
            if (!z.eq (toBigNumber ('0x0')) && (!x.eq (toBigNumber ('0x0')) || !y.eq (toBigNumber ('0x0')))) {
              ...
              var expectedLog = Math.log (Number (x)) * Number (y) / Number (z) +
                  (128 * (1.0 - Number (y) / Number (z))) * Math.LN2;
              if (expectedLog < 0.0) expectedLog = -1.0;
              if (x.eq (toBigNumber ('0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF')))
                expectedLog = 128 * Math.LN2;
    ...
    it("Test `yDaiOutForDaiIn` function", async() => {
        ...
        for (var i = 0; i < values.length; i++) {
          ...
          var result;
          try {
            result = await yieldMath.yDaiOutForDaiIn (
          ...
          var expected: any = values [i][7] !== undefined ? values [i][7] :
            Number (yDAIReserves) -
            Math.pow (
    ...
    it("Test `daiOutForYDaiIn` function", async() => {
        ...
        for (var i = 0; i < values.length; i++) {
          ...
          var result;
          try {
            result = await yieldMath.daiOutForYDaiIn (
    ...
    it("Test `yDaiInForDaiOut` function", async() => {
        var values = [
          ...
          ['0x0', '0x0', '0x0', '0x0', '0x0', '0x0', true],
          ['0x0', '0x0', '0x1', '0x0', '0x0', '0x0', false],
          ['0x80000000000000000000000000000000', '0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', '0x80000000000000000000000000000000', '0x0', '0x0', '0x0', true],
          ['0x80000000000000000000000000000000', '0x80000000000000000000000000000000', '0x80000000000000000000000000000000', '0x0', '0x0', '0x0', false],
          ['0xFEDCBA9876543210', '0x123456789ABCDEF0', '0x123456789ABC', '0x1', '0x8000000000000000', '0xFEDCBA9876543210', true]
        ];
        ...
        for (var i = 0; i < values.length; i++) {
          ...
          var result;
          try {
            result = await yieldMath.yDaiInForDaiOut (
              daiReserves, yDAIReserves, daiAmount, timeTillMaturity, k, g);
          } catch (e) {
            result = [false, undefined];
          }
    ...
    it("Test `daiInForYDaiOut` function", async() => {
        var values = [
          ...
          ['0x0', '0x0', '0x0', '0x1', '0xFFFFFFFFFFFFFFFF', '0x10000000000000000', true, 0.0],
          ['0x0', '0x0', '0x0', '0x1', '0x10000000000000000', '0x10000000000000000', false],
          ['0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF', '0x80000000000000000000000000000000', '0x80000000000000000000000000000000', '0x0', '0x0', '0x0', true],
          ['0x80000000000000000000000000000000', '0x80000000000000000000000000000000', '0x8000000000000000000000000000002D', '0x0', '0x0', '0x0', false],
          ['0xFEDCBA9876543210', '0x123456789ABCDEF0', '0x123456789ABC', '0x1', '0x8000000000000000', '0xFEDCBA9876543210', true]
        ];
        ...
        for (var i = 0; i < values.length; i++) {
          ...
          var result;
          try {
            result = await yieldMath.daiInForYDaiOut (
              daiReserves, yDAIReserves, yDAIAmount, timeTillMaturity, k, g);
          } catch (e) {
            result = [false, undefined];
          }
