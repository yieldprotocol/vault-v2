...
contract('Vat', async (accounts) =>  {
    ...
    describe('with funds joined', () => {
        ...
        it('should deposit collateral', async() => {
            await vat.frob(WETH, owner, owner, owner, wethTokens, 0, { from: owner });
        ...
        it('should not allow borrowing without enough collateral', async() => {
            ...
            // 120 * 1.25 <= 100 * 1.5
            await vat.frob(WETH, owner, owner, owner, wethTokens, daiDebt, { from: owner }); // weth 100, dai debt 120
            assert.equal(
                (await vat.urns(WETH, owner)).ink,   
                wethTokens.toString(),
                'We should have ' + wethTokens + ' weth as collateral.',
            ...
            await expectRevert(
                vat.frob(WETH, owner, owner, owner, -1, 0, { from: owner }), // Not a wei less collateral
                'Vat/not-safe',
            );
            await expectRevert(
                vat.frob(WETH, owner, owner, owner, 0, 1, { from: owner }), // Not a wei more debt
                'Vat/not-safe',
            );
        ...
        describe('with collateral deposited', () => {
            ...
            it('should withdraw collateral', async() => {
                ...
                await vat.frob(WETH, owner, owner, owner, unfrob, 0, { from: owner });
            ...
            it('should borrow Dai', async() => {
                ...
                await vat.frob(WETH, owner, owner, owner, 0, daiDebt, { from: owner });
            ...
            describe('with dai borrowed', () => {
                ...
                it('should return Dai', async() => {
                    ...
                    await vat.frob(WETH, owner, owner, owner, 0, undai, { from: owner });
                ...
                it('should return Dai and withdraw collateral', async() => {
                    ...
                    await daiJoin.join(owner, daiTokens, { from: owner });
                    await vat.frob(WETH, owner, owner, owner, unfrob, undai, { from: owner });
                    //let ink2 = (await vat.dai(WETH, owner)).ink.toString()
