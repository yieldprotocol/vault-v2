...
interface IConverter {
    ...
    event Wrapped(IYvToken indexed token, address indexed to, uint256 amount, uint256 wrappedAmount);
    ...
    event Unwrapped(IYvToken indexed token, address indexed to, uint256 amount, uint256 unwrappedAmount);
    ...
    function wrappedFrom(IYvToken token, uint256 assets) external view returns (uint256);
    ...
    function assetFrom(IYvToken token, uint256 wrappedAssets) external view returns (uint256);
    ...
    function wrappedFor(IYvToken token, uint256 assets) external view returns (uint256);
    ...
    function assetFor(IYvToken token, uint256 wrappedAssets) external view returns (uint256);
    ...
    function wrap(IYvToken token, address to) external returns (uint256 wrappedAmount);
    ...
    function unwrap(IYvToken token, address to) external returns (uint256 unwrappedAmount);
}
