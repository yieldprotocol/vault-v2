...
import Cvx3CrvOracleArtifact from '../artifacts/foundry-contracts/oracles/convex/Cvx3CrvOracle.sol/Cvx3CrvOracle.json'
import CurvePoolMockArtifact from '../artifacts/foundry-contracts/mocks/oracles/convex/CurvePoolMock.sol/CurvePoolMock.json'
import CompositeMultiOracleArtifact from '../artifacts/foundry-contracts/oracles/composite/CompositeMultiOracle.sol/CompositeMultiOracle.json'
import ConvexLadleModuleArtifact from '../artifacts/foundry-contracts/other/convex/ConvexModule.sol/ConvexModule.json'
import ConvexPoolMockArtifact from '../artifacts/foundry-contracts/mocks/ConvexPoolMock.sol/ConvexPoolMock.json'
import ConvexJoinArtifact from '../artifacts/foundry-contracts/other/convex/ConvexJoin.sol/ConvexJoin.json'
import ERC20MockArtifact from '../artifacts/foundry-contracts/mocks/ERC20Mock.sol/ERC20Mock.json'
import TokenProxyArtifact from '../artifacts/foundry-contracts/mocks/TokenProxy.sol/TokenProxy.json'
