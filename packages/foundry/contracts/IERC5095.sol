...
interface IERC5095 is IERC20 {
    ...
    function redeem(uint256 principalAmount, address to, address from) public returns (uint256 underlyingAmount);
    ...
    function withdraw(uint256 underlyingAmount, address to, address from) public returns (uint256 principalAmount);
}
