...
1. Give us more flexibility in exploring different liquidation models, including moving away from Dutch auctions to fixed discount if there is not enough competition from liquidators.
