...
contract VRWitch is AccessControl {
        ...
        )
    {
        ...
        (auction_, line) = _calcAuction(vault, to, balances, debt);
        ...
        returns (DataTypes.Auction memory auction_, DataTypes.Line memory line)
    {
        ...
        line = lines[vault.ilkId][vault.baseId];
    ...
    */
        ...
        )
    {
        ...
        if (auction_.start == 0) {
            ...
            (auction_, ) = _calcAuction(vault, to, balances, debt);
        }
